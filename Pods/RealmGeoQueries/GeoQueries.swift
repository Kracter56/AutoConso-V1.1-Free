...
public extension Realm {
     ...
     */
    func findInRegion<Element: Object>(type: Element.Type, region: MKCoordinateRegion, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> Results<Element> {
     ...
     */
    func findInBox<Element: Object>(type: Element.Type, box: GeoBox, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> Results<Element> {
     ...
     */
    func findNearby<Element: Object>(type: Element.Type, origin center: CLLocationCoordinate2D, radius: Double, sortAscending sort: Bool?, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> [Element] {
...
public extension RealmCollection where Element: Object {
     ...
     */
    func filterGeoRegion(region: MKCoordinateRegion, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> Results<Element> {
     ...
     */
    func filterGeoBox(box: GeoBox, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> Results<Element> {
    ...
    /**
     ...
     - returns: Found objects inside radius around the center coordinate
     */
    func filterGeoRadius(center: CLLocationCoordinate2D, radius: Double, sortAscending sort: Bool?, latitudeKey: String = "latitude", longitudeKey: String = "longitude") throws -> [Element] {
    ...
    func sortByDistance(center: CLLocationCoordinate2D, ascending: Bool, latitudeKey: String = "latitude", longitudeKey: String = "longitude") -> [Element] {
...
private extension RealmCollection where Element: Object {
     ...
     */
    func addDistance(center: CLLocationCoordinate2D, latitudeKey: String = "latitude", longitudeKey: String = "lng") -> [Element] {
