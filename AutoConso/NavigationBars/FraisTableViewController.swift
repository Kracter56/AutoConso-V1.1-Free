//
//  FraisTableViewController.swift
//  AutoConso
//
...
class FraisTableViewController: UITableViewController, GADBannerViewDelegate {

    var bannerView: GADBannerView!
    
    @IBOutlet weak var tableViewFrais: UITableView!
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        /*print("cars = ",self.result.count)
        
        if self.result.count == 0 {*/
            self.tableViewFrais.setEmptyMessage("Fonctionnalité en cours de développement")
        /*} else {
