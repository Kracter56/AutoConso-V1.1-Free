...
class AttachmentHandler: NSObject{
    ...
    var actionFileTypeHeading = NSLocalizedString("Associer un justificatif", comment: "actionFileTypeHeading")
    var actionFileTypeDescription = NSLocalizedString("Choisir un média", comment: "actionFileTypeDescription")
    var camera = NSLocalizedString("Appareil photo", comment: "camera")
    var phoneLibrary = NSLocalizedString("Galerie d'images", comment: "phoneLibrary")
    var video = NSLocalizedString("Vidéo", comment: "video")
    var file = NSLocalizedString("Document", comment: "file")
    ...
    func showAttachmentActionSheet(vc: UIViewController) {
        ...
        actionSheet.addAction(UIAlertAction(title: self.video, style: .default, handler: { (action) -> Void in
            self.authorisationStatus(attachmentTypeEnum: .video, vc: self.currentVC!)
            
        }))
        
        actionSheet.addAction(UIAlertAction(title: self.file, style: .default, handler: { (action) -> Void in
            self.documentPicker()
        }))
