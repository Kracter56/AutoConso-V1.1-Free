...
class Utility {
	...
	*/
	...
	/*static func alertBuilder(showCloseButton:Bool, title:String, message:String,type:String, button1:String, button2:String, type:String){
		...
		if(button1 != nil){
			popup.addButton(button1, backgroundColor: UIColor.gray, textColor: UIColor.white){
		...
		popup.showWarning(titlePeuxPasRejoindreVehicule, subTitle: messagePeuxPasRejoindreVehicule)

	}*/
	
	/*func localize(string: String) -> String {
		guard let localizedString = localizableDictionary.value(forKey: string) as? String else{ //valueForKey(string).valueForKey("value") as? String else {
