...
//	init(id:String, nom:String, marqueStation: String, adresseStation:String, CP:Int, villeStation:String, Latitude: Double, Longitude: Double) {
//		
//		self.idStation = id
//		self.nomStation = nom
//		self.marque = marqueStation
//		self.adresse = adresseStation
//		self.codePostal = CP
//		self.ville = villeStation
