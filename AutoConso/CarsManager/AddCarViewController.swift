    ...
    @IBAction func btnSaveCar(_ sender: UIBarButtonItem) {
        ...
        if (Validate() == true) {
            ...
            if ((Validate() == true)&&(valTest == true)) {
            	...
            	CWProgressHUD.dismiss()
				let messageConfirmVoitureCree = NSLocalizedString("La voiture a bien été créée", comment: "messageConfirmVoitureCree")
                self.toastMessage(messageConfirmVoitureCree)
